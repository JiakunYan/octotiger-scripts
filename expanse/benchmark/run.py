...
configs = [
    ...
    # {**baseline, "name": "lci_putsendrecv_sync_worker", "protocol": "putsendrecv", "comp_type": "sync", "progress_type": "worker", "sendimm": 0},
    # {**baseline, "name": "lci_putsendrecv_sync_pthread", "protocol": "putsendrecv", "comp_type": "sync", "progress_type": "pthread", "sendimm": 0},
    # {**baseline, "name": "lci_putsendrecv_sync_rp", "protocol": "putsendrecv", "comp_type": "sync", "sendimm": 0},
    # {**baseline, "name": "lci_putsendrecv_sync_worker_sendimm", "protocol": "putsendrecv", "comp_type": "sync", "progress_type": "worker"},
    # {**baseline, "name": "lci_putsendrecv_sync_pthread_sendimm", "protocol": "putsendrecv", "comp_type": "sync", "progress_type": "pthread"},
    # {**baseline, "name": "lci_putsendrecv_sync_rp_sendimm", "protocol": "putsendrecv", "comp_type": "sync"},
    # {**baseline, "name": "lci_putsendrecv_queue_worker", "protocol": "putsendrecv", "progress_type": "worker", "sendimm": 0},
    # {**baseline, "name": "lci_putsendrecv_queue_pthread", "protocol": "putsendrecv", "progress_type": "pthread", "sendimm": 0},
    ...
    # {**baseline, "name": "lci_putsendrecv_queue_pthread_sendimm", "protocol": "putsendrecv", "progress_type": "pthread"},
    ...
    # {**baseline, "name": "lci_putsendrecv_queue_rp_sendimm_bq", "protocol": "putsendrecv", "backlog_queue": 1},
    # 2 devices
    ...
    # {**baseline, "name": "lci_putsendrecv_queue_rp_sendimm_nozcr", "protocol": "putsendrecv", "zero_copy_recv": 0},
    # Others
...
if __name__ == "__main__":
    ...
    for config in configs:
        ...
        for nnodes in config["nnodes_list"]:
            run_slurm(tag, nnodes, config, time="00:02:00")