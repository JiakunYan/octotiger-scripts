...
configs = [
    # {**baseline, "nnodes_list": [32], "name": "mpi", "parcelport": "mpi", "sendimm": 0},
    # {**baseline, "nnodes_list": [32], "name": "mpi_i", "parcelport": "mpi", "sendimm": 1},
    # {**baseline, "nnodes_list": [32], "name": "lci_pin_d2_c2", "parcelport": "lci"},
    # {**baseline, "nnodes_list": [32], "name": "lci_pin_d2_c1", "parcelport": "lci", "ncomps": 1},
    # # LCI v.s. MPI
